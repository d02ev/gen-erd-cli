...
export const CLI_LABEL_INDIVIDUAL_FIELDS = 'Credentials';
export const CLI_LABEL_WINDOWS_AUTH = 'Windows Authentication';
export const CLI_LABEL_AZURE_AD = 'Azure AD (Entra ID)';
export const CLI_LABEL_AWS_IAM = 'AWS IAM';
...
export const CONNECTION_TYPE_CONNECTION_STRING = 'connectionString';
export const CONNECTION_TYPE_CREDENTIALS = 'credentials';
export const CONNECTION_TYPE_WINDOWS_AUTH = 'windowsAuth';
export const CONNECTION_TYPE_AZURE_AD = 'azureAd';
export const CONNECTION_TYPE_AWS_IAM = 'awsIam';

export const CONNECTION_TYPES_BY_DB = Object.freeze({
  [DB_TYPE_POSTGRES]: [CONNECTION_TYPE_CONNECTION_STRING, CONNECTION_TYPE_CREDENTIALS, CONNECTION_TYPE_AWS_IAM, CONNECTION_TYPE_AZURE_AD],
  [DB_TYPE_MYSQL]: [CONNECTION_TYPE_CONNECTION_STRING, CONNECTION_TYPE_CREDENTIALS, CONNECTION_TYPE_AZURE_AD],
  [DB_TYPE_MSSQL]: [CONNECTION_TYPE_CONNECTION_STRING, CONNECTION_TYPE_CREDENTIALS, CONNECTION_TYPE_WINDOWS_AUTH, CONNECTION_TYPE_AZURE_AD],
  [DB_TYPE_SQLITE]: [CONNECTION_TYPE_CONNECTION_STRING, CONNECTION_TYPE_CREDENTIALS],
  [DB_TYPE_ORACLE]: [CONNECTION_TYPE_CONNECTION_STRING, CONNECTION_TYPE_CREDENTIALS, CONNECTION_TYPE_AZURE_AD],
});